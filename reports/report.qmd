...
run_sql_and_return_html(cnx,"""
select 
  country_region, count(country_code)
from
  world_bank_data.wdi_country 
group by
  country_region
...
run_sql_and_return_html(cnx,"""
select 
  country_long_name, country_region
from
  world_bank_data.wdi_country 
where
...
run_sql_and_return_html(cnx,"""
select 
  country_region, country_short_name, country_long_name
from 
  world_bank_data.wdi_country 
where
  table_name = "Qatar"
...
run_sql_and_return_html(cnx,"""
select 
  country_code, country_short_name, abbr, wb_abbr, country_region
from 
  world_bank_data.wdi_country 
where
  abbr != wb_abbr
...
run_sql_and_return_html(cnx,"""
select 
  country_income_category, count(country_code)
from 
  world_bank_data.wdi_country 
group by
...
run_sql_and_return_html(cnx,"""
select 
  region, country_income_group, count(country_code)
from 
  world_bank_data.wdi_country 
group by
...
run_sql_and_return_html(cnx,"""
select 
  country_code, country_short_name, country_region, country_income_category
from 
  world_bank_data.wdi_country 
order by 
  country_short_name
